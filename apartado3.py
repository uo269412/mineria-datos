...
with open('datos_adicionales/pickle/apartado3/sorted_docs_per_cluster1.pickle', 'wb') as archivo:
    pickle.dump(sorted_docs_per_cluster1, archivo)

with open('datos_adicionales/pickle/apartado3/docs_per_cluster1.pickle', 'wb') as archivo:
    pickle.dump(docs_per_cluster1, archivo)

with open('datos_adicionales/pickle/apartado3/indice_cluster_terminos1.pickle', 'wb') as archivo:
    pickle.dump(indice_cluster_terminos1, archivo)

with open('datos_adicionales/pickle/apartado3/clustering1.pickle', 'wb') as archivo:
    pickle.dump(clustering1, archivo)

with open('datos_adicionales/pickle/apartado3/clustered_docs1.pickle', 'wb') as archivo:
    pickle.dump(clustered_docs1, archivo)

with open('datos_adicionales/pickle/apartado3/terminos.pickle', 'wb') as archivo:
